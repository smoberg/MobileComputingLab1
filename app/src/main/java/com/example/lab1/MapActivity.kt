...
class MapActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        map_create.setOnClickListener {
            ...
            if (selectedLocation==null){
                toast("please select location on the map")
                return@setOnClickListener
            }
    ...
    private fun createGeofence(selectecLocation:LatLng, reminder: Reminder,geofencingClient: GeofencingClient) {
        val geofence = Geofence.Builder()
            .setRequestId(GEOFENCE_ID)
            .setCircularRegion(selectecLocation.latitude, selectecLocation.longitude, GEOFENCE_RADIUS.toFloat())
    ...
    override fun onMapReady(map: GoogleMap?) {
        ...
        if (ContextCompat.checkSelfPermission(
            ...
            fusedLocationClient.lastLocation.addOnSuccessListener { location: Location? ->
                ...
                if (location != null) {
                    ...
                    with(gMap) { animateCamera(CameraUpdateFactory.newLatLngZoom(latLong, 13f)) }
        ...
        gMap.setOnMapClickListener { location:LatLng->
            ...
            try {
                ...
                addCircle(CircleOptions().center(location).strokeColor(Color.argb(50,70,70,70)).fillColor(Color.argb(100,50,50,50)))
